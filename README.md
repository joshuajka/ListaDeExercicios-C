...
<h3>Entrada
A entrada conter ́a v ́arias linhas. A primeira delas cont ́em o n ́umero n de temperaturas em Fahrenheit
...
<h3>Saída
O programa deve imprimir n linhas cada uma no seguinte formato x FAHRENHEIT EQUIVALE A
